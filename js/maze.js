...
function endGame(){
    if(isOnPepper){ 
        ...
        hist["participantID"]= participantID;
...
function downloadData(){ 
    //called twice per participant, once per game (so two lines per participants), only if isOnPepper == true
